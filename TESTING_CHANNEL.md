...
1. **Magic combat mode.** Backtick toggles combat mode; `NamedKeys.Backtick` posts it, and
   the keymap binds `DIK_END` to `CombatCastCurrentSpell` in MagicCombat mode. The
   combat-mode helper (section 10) can drive this.
